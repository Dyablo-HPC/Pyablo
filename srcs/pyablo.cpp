...
PYBIND11_MODULE(pyablo, m) {
  ...
  py::class_<dyablo::Snapshot>(m, "Snapshot")
    ...
    .def("getCellsVolume", static_cast<std::vector<real_t> (Snapshot::*)(std::vector<uint>)>(&Snapshot::getCellVolume))
    .def("getGridVertex",  static_cast<std::vector<Vec> (Snapshot::*)(std::vector<uint>, std::array<uint, 2>)>(&Snapshot::getGridVertex))

    .def("probeDensity",    static_cast<std::vector<real_t> (Snapshot::*)(std::vector<Vec>)>(&Snapshot::probeDensity))
    .def("probePressure",   static_cast<std::vector<real_t> (Snapshot::*)(std::vector<Vec>)>(&Snapshot::probePressure))
    .def("probeEnergy",     static_cast<std::vector<real_t> (Snapshot::*)(std::vector<Vec>)>(&Snapshot::probeTotalEnergy))
    .def("probeMach",       static_cast<std::vector<real_t> (Snapshot::*)(std::vector<Vec>)>(&Snapshot::probeMach))
    ...
    .def("getDensity",  static_cast<std::vector<real_t> (Snapshot::*)(std::vector<uint>)>(&Snapshot::getDensity))
    .def("getPressure", static_cast<std::vector<real_t> (Snapshot::*)(std::vector<uint>)>(&Snapshot::getPressure))
    .def("getEnergy",   static_cast<std::vector<real_t> (Snapshot::*)(std::vector<uint>)>(&Snapshot::getTotalEnergy))
    .def("getMach",     static_cast<std::vector<real_t> (Snapshot::*)(std::vector<uint>)>(&Snapshot::getMach))
    ...
    .def("getRefinementCriterion",  static_cast<std::vector<real_t> (Snapshot::*)(std::vector<Vec>)>(&Snapshot::getRefinementCriterion))
  
    .def("getTotalMass",                 static_cast<real_t (Snapshot::*)()>(&Snapshot::getTotalMass))
    .def("getTotalEnergy",               static_cast<real_t (Snapshot::*)()>(&Snapshot::getTotalEnergy))
    .def("getTotalKineticEnergy",        static_cast<real_t (Snapshot::*)()>(&Snapshot::getTotalKineticEnergy))
    .def("getTotalInternalEnergy",       static_cast<real_t (Snapshot::*)(double)>(&Snapshot::getTotalInternalEnergy))
    .def("getMaxMach",                   static_cast<real_t (Snapshot::*)()>(&Snapshot::getMaxMach))
    .def("getAverageMach",               static_cast<real_t (Snapshot::*)()>(&Snapshot::getAverageMach))
    .def("getTime",                      static_cast<real_t (Snapshot::*)()>(&Snapshot::getTime))

    .def("readAllFloat",     static_cast<std::vector<real_t> (Snapshot::*)(std::string)>(&Snapshot::readAllFloat))
    .def("mortonSort2d",     static_cast<std::vector<real_t> (Snapshot::*)(std::vector<real_t>, uint, uint, uint)>(&Snapshot::mortonSort2d))
    .def("mortonSort3d",     static_cast<std::vector<real_t> (Snapshot::*)(std::vector<real_t>, uint, uint, uint, uint)>(&Snapshot::mortonSort3d))
