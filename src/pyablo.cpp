...
PYBIND11_MODULE(_pyablo, m) {
  ...
  py::class_<dyablo::Snapshot>(m, "Snapshot")
    ...
    .def("getMagneticField", static_cast<std::vector<Vec>   (Snapshot::*)(std::vector<uint>)>(&Snapshot::getMagneticField))
    ...
    .def("getTotalMagneticEnergy",       static_cast<double (Snapshot::*)()>(&Snapshot::getTotalMagneticEnergy))
    .def("getTotalMagneticDivergence",       static_cast<double (Snapshot::*)()>(&Snapshot::getTotalMagneticDivergence))
